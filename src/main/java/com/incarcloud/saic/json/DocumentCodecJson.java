 ...
 * @since 3.0
 */
public class DocumentCodecJson implements CollectibleCodec<DocumentJson> {
     ...
     * @since 3.5
     */
    public DocumentCodecJson(final CodecRegistry registry) {
     ...
     */
    public DocumentCodecJson(final CodecRegistry registry, final BsonTypeClassMap bsonTypeClassMap) {
     ...
     */
    public DocumentCodecJson(final CodecRegistry registry, final BsonTypeClassMap bsonTypeClassMap, final Transformer valueTransformer) {
    ...
    @Override
    public boolean documentHasId(final DocumentJson document) {
        return document.containsKey(ID_FIELD_NAME);
    }

    @Override
    public BsonValue getDocumentId(final DocumentJson document) {
    ...
    @Override
    public DocumentJson generateIdIfAbsentFromDocument(final DocumentJson document) {
        if (!documentHasId(document)) {
    ...
    @Override
    public void encode(final BsonWriter writer, final DocumentJson document, final EncoderContext encoderContext) {
        writeMap(writer, document, encoderContext);
    }

    @Override
    public DocumentJson decode(final BsonReader reader, final DecoderContext decoderContext) {
        DocumentJson document = new DocumentJson();
    ...
    @Override
    public Class<DocumentJson> getEncoderClass() {
        return DocumentJson.class;
    }
